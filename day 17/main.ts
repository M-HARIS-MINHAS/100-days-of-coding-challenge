...
function myIdea(...hobbies:string[]){
...
//orignal function
function calculatesArea(length:number,width:number):number{
    return length*width
}

//Refactored to Arrow Function
let calculatesArea1 =(length:number,width:number):number=>length*width;
